...
const formSchema = z.object({
  businessname: z.string().min(2, { message: "Businessname must be at least 2 characters." }),
})
...
const OnboardingStepper = () => {
  ...
  const [keyGoals, setKeyGoals] = useState<string | null>(null);
  ...
  <FormDescription>This is your current business stage.</FormDescription>
  <FormMessage />
</FormItem>
  <FormItem>
  ...
  <FormControl>
    ...
    >
      ...
      <SelectContent>
        <SelectItem value="idea">SaaS</SelectItem>
        <SelectItem value="pre-revenue">E-commerce</SelectItem>
        <SelectItem value="growth">Agency</SelectItem>
        <SelectItem value="growth">Other</SelectItem>
      </SelectContent>
    </Select>
  </FormControl>
  ...
  <FormControl>
    ...
    >
      ...
      <SelectContent>
        <SelectItem value="idea">1-10</SelectItem>
        <SelectItem value="pre-revenue">10-100</SelectItem>
        <SelectItem value="growth">100-500</SelectItem>
        <SelectItem value="growth">More than 500</SelectItem>
      </SelectContent>
    </Select>
  </FormControl>
  ...
  <FormControl>
    <Select
      onValueChange={(value) => setKeyGoals(value)}
      value={stage ?? undefined}
    >
      <SelectTrigger className="w-full">
        <SelectValue placeholder="Select stage" />
      ...
      <SelectContent>
        <SelectItem value="idea">Sales</SelectItem>
        <SelectItem value="pre-revenue">Marketing</SelectItem>
        <SelectItem value="growth">Ops</SelectItem>
        <SelectItem value="growth">Finance</SelectItem>
        <SelectItem value="growth">Product</SelectItem>
      </SelectContent>
    </Select>
  </FormControl>
